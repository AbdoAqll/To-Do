package com.example.to_do.ui.late
...
import com.example.to_do.databinding.LateFragmentBinding
import com.example.to_do.ui.home.HomeAdapter
import com.example.to_do.ui.home.TaskInteractionInterface
import java.time.LocalDateTime

class LateFragment : BaseFragment<LateFragmentBinding>() , TaskInteractionInterface {
    lateinit var adapter: HomeAdapter
    private var tasks = DataManager.getLate()
    override var bindingInflationFunction: (LayoutInflater, ViewGroup?, Boolean) -> LateFragmentBinding = LateFragmentBinding :: inflate
    ...
    override fun setup() {
        ...
        binding.lateRecyclerView.adapter = adapter
        adapter.setData(DataManager.getLate())
    }
