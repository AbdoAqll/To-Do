package com.example.to_do.ui.important
...
import com.example.to_do.databinding.ImportantFragmentBinding
import com.example.to_do.ui.home.HomeAdapter
import com.example.to_do.ui.home.TaskInteractionInterface
import java.time.LocalDateTime

class ImportantFragment : BaseFragment<ImportantFragmentBinding>() , TaskInteractionInterface {
    lateinit var adapter: HomeAdapter
    private var tasks = DataManager.getImportant()
    override var bindingInflationFunction: (LayoutInflater, ViewGroup?, Boolean) -> ImportantFragmentBinding = ImportantFragmentBinding :: inflate
    ...
    override fun setup() {
        ...
        binding.importantRecyclerView.adapter = adapter
        adapter.setData(DataManager.getImportant())
    }
